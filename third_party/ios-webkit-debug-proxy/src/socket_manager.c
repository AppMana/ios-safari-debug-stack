...
int sm_listen(int port) {
  ...
  /*
   * The inspector endpoint grants arbitrary JavaScript execution in the
   * connected page.  Keep the downstream Ubuntu service local-only instead
   * of exposing it on every network interface.
   */
